...
import { getGames, saveGames, getJobs, saveJobs, Game, Job, saveSettings, Settings, getAboutSettings, saveAboutSettings, AboutSettings } from '@/utils/db';
...
// About Actions
// -------------------------------------------------------------
export async function saveAboutAction(aboutData: AboutSettings) {
  await assertAuthorized();
  await saveAboutSettings(aboutData);
  revalidatePath('/');
  revalidatePath('/admin/dashboard');
  return { success: true };
}
