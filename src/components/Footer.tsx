...
export default function Footer() {
  ...
  return (
    <footer className="bg-carbon-black border-t border-graphite-light py-16 px-6 text-alabaster-grey">
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
        ...
        <div className="flex flex-col gap-4">
          ...
          <div className="flex flex-col gap-2 mt-4 text-xs font-outfit font-light">
            <Link href="/privacy-policy" className="hover:text-bright-snow transition-colors">
              Privacy Policy
            </Link>
            <Link href="/terms-of-services" className="hover:text-bright-snow transition-colors">
              Terms of Services
            </Link>
          </div>
        </div>
